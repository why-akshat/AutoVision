...
def constrastLimit(image):
    img_hist_equalized = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
    img_hist_equalized = cv2.equalizeHist(img_hist_equalized)
    img_hist_equalized = cv2.cvtColor(img_hist_equalized, cv2.COLOR_GRAY2BGR)
    return img_hist_equalized
